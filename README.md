# Olá, eu sou o Leandro Bitencort! 👋
...
- **Linguagens:** C e Python (em aprendizado)  
...
- **[🚦 Sistema de Filas Edubank](https://github.com/LeandroHBitencort/Gerenciamento_Fila.git)**: Integração Python + C para gestão de senhas e atendimento real.
